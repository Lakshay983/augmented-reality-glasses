...
module image_passthrough_hls_deadlock_idx0_monitor ( // for module image_passthrough_image_passthrough_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[0] = idx1_block & (1'b0 | axis_block_sigs[1] | axis_block_sigs[0]);
...
// instant sub module
 image_passthrough_hls_deadlock_idx1_monitor image_passthrough_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
