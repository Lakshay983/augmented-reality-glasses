...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_in_rows_c \
    op interface \
    ports { img_in_rows_c_din { O 32 vector } img_in_rows_c_num_data_valid { I 2 vector } img_in_rows_c_fifo_cap { I 2 vector } img_in_rows_c_full_n { I 1 bit } img_in_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_in_cols_c \
    op interface \
    ports { img_in_cols_c_din { O 32 vector } img_in_cols_c_num_data_valid { I 2 vector } img_in_cols_c_fifo_cap { I 2 vector } img_in_cols_c_full_n { I 1 bit } img_in_cols_c_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 58
set RegSliceName image_passthrough_regslice_both
set RegSliceInstName image_passthrough_regslice_both_U
set CoreName ap_simcore_image_passthrough_regslice_both
