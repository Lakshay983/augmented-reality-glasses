...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { tile_pong_V_address0 { O 15 vector } tile_pong_V_ce0 { O 1 bit } tile_pong_V_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { tile_ping_V_address0 { O 15 vector } tile_ping_V_ce0 { O 1 bit } tile_ping_V_q0 { I 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 17 \
    name first_out_pixel \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_first_out_pixel \
    op interface \
    ports { first_out_pixel { I 1 vector } } \
} "
}
