set moduleName axiStrm2hlsStrm_128_460_640_4_4_8_73600_Pipeline_VITIS_LOOP_594_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {axiStrm2hlsStrm<128, 460, 640, 4, 4, 8, 73600>_Pipeline_VITIS_LOOP_594_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ loop_count int 26 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "loop_count", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ strm_din sc_out sc_lv 128 signal 5 } 
	{ strm_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ strm_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ strm_full_n sc_in sc_logic 1 signal 5 } 
	{ strm_write sc_out sc_logic 1 signal 5 } 
	{ loop_count sc_in sc_lv 26 signal 0 } 
	{ stream_in_TDATA sc_in sc_lv 128 signal 1 } 
	{ stream_in_TREADY sc_out sc_logic 1 inacc 4 } 
	{ stream_in_TKEEP sc_in sc_lv 16 signal 2 } 
	{ stream_in_TSTRB sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "loop_count", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "loop_count", "role": "default" }} , 
...
set Spec2ImplPortList { 
	loop_count { ap_none {  { loop_count in_data 0 26 } } }
	stream_in_V_data_V { axis {  { stream_in_TVALID in_vld 0 1 }  { stream_in_TDATA in_data 0 128 } } }
