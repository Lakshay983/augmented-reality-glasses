...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_strm \
    op interface \
    ports { strm_dout { I 32 vector } strm_num_data_valid { I 2 vector } strm_fifo_cap { I 2 vector } strm_empty_n { I 1 bit } strm_read { O 1 bit } } \
} "
}
