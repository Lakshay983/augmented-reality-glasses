set moduleName xfGaussianFilter3x3_0_460_640_1_0_4_2_2_12_160_Pipeline_Clear_Row_Loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xfGaussianFilter3x3<0, 460, 640, 1, 0, 4, 2, 2, 12, 160>_Pipeline_Clear_Row_Loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_width int 16 regular  }
	{ buf_V_1 int 32 regular {array 160 { 3 0 } 0 1 }  }
	{ buf_V int 32 regular {array 160 { 3 0 } 0 1 }  }
	{ img_gray_data48 int 32 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "img_width", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "buf_V_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ img_gray_data48_dout sc_in sc_lv 32 signal 3 } 
	{ img_gray_data48_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ img_gray_data48_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ img_gray_data48_empty_n sc_in sc_logic 1 signal 3 } 
	{ img_gray_data48_read sc_out sc_logic 1 signal 3 } 
	{ img_width sc_in sc_lv 16 signal 0 } 
	{ buf_V_1_address1 sc_out sc_lv 8 signal 1 } 
	{ buf_V_1_ce1 sc_out sc_logic 1 signal 1 } 
	{ buf_V_1_we1 sc_out sc_logic 1 signal 1 } 
	{ buf_V_1_d1 sc_out sc_lv 32 signal 1 } 
	{ buf_V_address1 sc_out sc_lv 8 signal 2 } 
	{ buf_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ buf_V_we1 sc_out sc_logic 1 signal 2 } 
	{ buf_V_d1 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	buf_V_1 { ap_memory {  { buf_V_1_address1 MemPortADDR2 1 8 }  { buf_V_1_ce1 MemPortCE2 1 1 }  { buf_V_1_we1 MemPortWE2 1 1 }  { buf_V_1_d1 MemPortDIN2 1 32 } } }
	buf_V { ap_memory {  { buf_V_address1 MemPortADDR2 1 8 }  { buf_V_ce1 MemPortCE2 1 1 }  { buf_V_we1 MemPortWE2 1 1 }  { buf_V_d1 MemPortDIN2 1 32 } } }
