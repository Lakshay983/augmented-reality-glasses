...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_TVALID { I 1 bit } stream_in_TDATA { I 128 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_strm \
    op interface \
    ports { strm_din { O 128 vector } strm_num_data_valid { I 2 vector } strm_fifo_cap { I 2 vector } strm_full_n { I 1 bit } strm_write { O 1 bit } } \
} "
}
