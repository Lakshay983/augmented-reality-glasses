...
entity accelerator_v2_fifo_w24_d3864_A is
    generic (
...
architecture arch of accelerator_v2_fifo_w24_d3864_A is

    -- component
    component accelerator_v2_fifo_w24_d3864_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_accelerator_v2_fifo_w24_d3864_A_ram : accelerator_v2_fifo_w24_d3864_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity accelerator_v2_fifo_w24_d3864_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 24;
        ADDR_WIDTH  : integer := 12;
...
architecture arch of accelerator_v2_fifo_w24_d3864_A_ram is
