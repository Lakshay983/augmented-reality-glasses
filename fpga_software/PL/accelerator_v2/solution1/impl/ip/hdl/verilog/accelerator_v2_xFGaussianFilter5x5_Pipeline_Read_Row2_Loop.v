...
module accelerator_v2_xFGaussianFilter5x5_Pipeline_Read_Row2_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [9:0] col_V_fu_44;
wire   [9:0] col_V_2_fu_86_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_col_V_1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln774_fu_80_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln774_fu_80_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_col_V_1 = 10'd0;
    end else begin
...
assign icmp_ln774_fu_80_p2 = ((ap_sig_allocacmp_col_V_1 == 10'd644) ? 1'b1 : 1'b0);

assign zext_ln541_fu_97_p1 = col_V_1_reg_108;

endmodule //accelerator_v2_xFGaussianFilter5x5_Pipeline_Read_Row2_Loop
