...
entity accelerator_v2_bgr2gray_9_0_484_644_1_311696_311696_Pipeline_columnloop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of accelerator_v2_bgr2gray_9_0_484_644_1_311696_311696_Pipeline_columnloop is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln5582_fu_81_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_1_reg_185 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_1_reg_185_pp0_iter2_reg : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_145_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal j_V_fu_56 : STD_LOGIC_VECTOR (9 downto 0);
    signal j_V_2_fu_87_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_j_V_1 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal p_2_fu_112_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_151_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal grp_fu_160_p3 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_145_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_145_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_fu_151_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_151_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_fu_160_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_160_p1 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal grp_fu_145_p00 : STD_LOGIC_VECTOR (21 downto 0);
    signal grp_fu_151_p00 : STD_LOGIC_VECTOR (19 downto 0);
    signal grp_fu_160_p00 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_160_p20 : STD_LOGIC_VECTOR (22 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component accelerator_v2_mul_mul_8ns_14ns_22_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component accelerator_v2_mac_muladd_8ns_12ns_22ns_22_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component accelerator_v2_mac_muladd_8ns_15ns_22ns_23_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mul_mul_8ns_14ns_22_4_1_U68 : component accelerator_v2_mul_mul_8ns_14ns_22_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    mac_muladd_8ns_12ns_22ns_22_4_1_U69 : component accelerator_v2_mac_muladd_8ns_12ns_22ns_22_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    mac_muladd_8ns_15ns_22ns_23_4_1_U70 : component accelerator_v2_mac_muladd_8ns_15ns_22ns_23_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    j_V_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln5582_fu_81_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_V_fu_56 <= j_V_2_fu_87_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_V_fu_56 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                p_1_reg_185_pp0_iter2_reg <= p_1_reg_185;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln5582_fu_81_p2)
    begin
        if (((icmp_ln5582_fu_81_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_j_V_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_V_fu_56, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_V_1 <= ap_const_lv10_0;
        else 
            ap_sig_allocacmp_j_V_1 <= j_V_fu_56;
        end if; 
    end process;
    ...
    grp_fu_145_p0 <= grp_fu_145_p00(8 - 1 downto 0);
    grp_fu_145_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_2_fu_112_p4),22));
    grp_fu_145_p1 <= ap_const_lv22_2646(14 - 1 downto 0);
    ...
    grp_fu_151_p0 <= grp_fu_151_p00(8 - 1 downto 0);
    grp_fu_151_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_reg_180),20));
    grp_fu_151_p1 <= ap_const_lv20_E98(12 - 1 downto 0);
    ...
    grp_fu_160_p0 <= grp_fu_160_p00(8 - 1 downto 0);
    grp_fu_160_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_1_reg_185_pp0_iter2_reg),23));
    grp_fu_160_p1 <= ap_const_lv23_4B23(15 - 1 downto 0);
    grp_fu_160_p2 <= grp_fu_160_p20(22 - 1 downto 0);
