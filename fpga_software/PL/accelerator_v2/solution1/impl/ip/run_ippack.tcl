...
set Library     "hls"
set IPName      "accelerator_v2"
set Version     "4.3"
set DisplayName "Accelerator_v4.3"
set Revision    "2114563085"
...
set xo_kernel_name "accelerator_v2"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/misc/scratch/gwl459/augmented-reality-glasses/fpga_software/PL/accelerator_v2/solution1"
set debug_dir "/misc/scratch/gwl459/augmented-reality-glasses/fpga_software/PL/accelerator_v2/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {accelerator_v2_flow_control_loop_pipe_sequential_init
...
accelerator_v2_regslice_both
accelerator_v2_regslice_both
accelerator_v2_flow_control_loop_pipe_sequential_init
...
accelerator_v2_flow_control_loop_pipe
accelerator_v2_mul_mul_8ns_14ns_22_4_1
accelerator_v2_mac_muladd_8ns_12ns_22ns_22_4_1
accelerator_v2_mac_muladd_8ns_15ns_22ns_23_4_1
accelerator_v2_flow_control_loop_pipe_sequential_init
accelerator_v2_flow_control_loop_pipe_sequential_init
accelerator_v2_flow_control_loop_pipe_sequential_init
...
accelerator_v2_flow_control_loop_pipe
accelerator_v2_fifo_w24_d3220_A
accelerator_v2_fifo_w8_d3220_A
accelerator_v2_fifo_w8_d3220_A
accelerator_v2_start_for_bgr2gray_9_0_484_644_1_3220_3220_U0
accelerator_v2_start_for_GaussianBlur_5_1_0_484_644_1_3220_3220_U0
accelerator_v2_start_for_mat_to_stream_U0
accelerator_v2_flow_control_loop_pipe_sequential_init
accelerator_v2_flow_control_loop_pipe_sequential_init
...
accelerator_v2_regslice_both
accelerator_v2_regslice_both
accelerator_v2_fifo_w24_d2560_A
accelerator_v2_fifo_w24_d3864_A
accelerator_v2_fifo_w8_d3864_A
accelerator_v2_start_for_pad_U0
accelerator_v2_start_for_process_pixels_U0
accelerator_v2_start_for_repack_U0
...
## Variables
set Top "accelerator_v2"
set TopNoPrefix "accelerator_v2"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 in_breath R 0x0 "Data signal of in_breath" {{0 8 in_breath R 0 "Bit 7 to 0 of in_breath"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 in_breath_ctrl R 0x0 "Control signal of in_breath" {{0 1 in_breath_ap_vld R 0 "Control signal in_breath_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 out_breath R 0x0 "Data signal of out_breath" {{0 8 out_breath R 0 "Bit 7 to 0 of out_breath"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 out_breath_ctrl R 0x0 "Control signal of out_breath" {{0 1 out_breath_ap_vld R 0 "Control signal out_breath_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 bgr_fifo_breath R 0x0 "Data signal of bgr_fifo_breath" {{0 8 bgr_fifo_breath R 0 "Bit 7 to 0 of bgr_fifo_breath"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 bgr_fifo_breath_ctrl R 0x0 "Control signal of bgr_fifo_breath" {{0 1 bgr_fifo_breath_ap_vld R 0 "Control signal bgr_fifo_breath_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 pad_fifo_breath R 0x0 "Data signal of pad_fifo_breath" {{0 8 pad_fifo_breath R 0 "Bit 7 to 0 of pad_fifo_breath"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 pad_fifo_breath_ctrl R 0x0 "Control signal of pad_fifo_breath" {{0 1 pad_fifo_breath_ap_vld R 0 "Control signal pad_fifo_breath_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 gray_fifo_breath R 0x0 "Data signal of gray_fifo_breath" {{0 8 gray_fifo_breath R 0 "Bit 7 to 0 of gray_fifo_breath"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 gray_fifo_breath_ctrl R 0x0 "Control signal of gray_fifo_breath" {{0 1 gray_fifo_breath_ap_vld R 0 "Control signal gray_fifo_breath_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 924481 II x}
