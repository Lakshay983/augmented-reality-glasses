...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /usr/local/packages/Xilinx_2022.2/Vitis_HLS/2022.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/packages/Xilinx_2022.2/Vitis_HLS/2022.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/packages/Xilinx_2022.2/Vitis_HLS/2022.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/packages/Xilinx_2022.2/Vitis_HLS/2022.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "accelerator_v2.autotvin.dat"
	set constFileTvOut       "accelerator_v2.autotvout.dat"
	set constFileHdlTvIn     "accelerator_v2.autohdltvin.dat"
	set constFileHdlTvOut    "accelerator_v2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
