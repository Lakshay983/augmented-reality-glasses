...
module accelerator_v2_xFGaussianFilter5x5_Pipeline_Clear_Row_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] zext_ln541_reg_155;
reg    ap_block_pp0_stage0_11001;
reg   [9:0] col_V_fu_50;
wire   [9:0] col_V_6_fu_128_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_col_V_5;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_col_V_5 = 10'd0;
    end else begin
...
assign buf_V_1_address1 = zext_ln541_fu_134_p1;

assign buf_V_1_d1 = 8'd0;

assign buf_V_2_address1 = zext_ln541_reg_155;

assign buf_V_2_d1 = gray_mat_data44_dout;

assign buf_V_address1 = zext_ln541_fu_134_p1;
...
always @ (posedge ap_clk) begin
    zext_ln541_reg_155[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end

endmodule //accelerator_v2_xFGaussianFilter5x5_Pipeline_Clear_Row_Loop
