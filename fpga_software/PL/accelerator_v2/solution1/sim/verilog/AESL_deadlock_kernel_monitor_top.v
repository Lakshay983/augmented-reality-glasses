...
assign axis_block_sigs[1] = ~AESL_inst_accelerator_v2.unpack_U0.grp_unpack_Pipeline_VITIS_LOOP_84_2_fu_101.in_stream_TDATA_blk_n;
assign axis_block_sigs[2] = ~AESL_inst_accelerator_v2.repack_U0.out_stream_TDATA_blk_n;
assign axis_block_sigs[3] = ~AESL_inst_accelerator_v2.repack_U0.grp_repack_Pipeline_VITIS_LOOP_291_3_fu_143.out_stream_TDATA_blk_n;

assign inst_idle_sigs[0] = AESL_inst_accelerator_v2.unpack_U0.ap_idle;
assign inst_block_sigs[0] = (AESL_inst_accelerator_v2.unpack_U0.ap_done & ~AESL_inst_accelerator_v2.unpack_U0.ap_continue) | ~AESL_inst_accelerator_v2.unpack_U0.grp_unpack_Pipeline_VITIS_LOOP_84_2_fu_101.bgr_stream1_blk_n;
assign inst_idle_sigs[1] = AESL_inst_accelerator_v2.pad_U0.ap_idle;
assign inst_block_sigs[1] = (AESL_inst_accelerator_v2.pad_U0.ap_done & ~AESL_inst_accelerator_v2.pad_U0.ap_continue) | ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_133_1_VITIS_LOOP_134_2_fu_348.bgr_stream1_blk_n | ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_159_10_fu_372.bgr_stream1_blk_n | ~AESL_inst_accelerator_v2.pad_U0.padded_stream2_blk_n | ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_179_19_fu_396.padded_stream2_blk_n | ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_144_6_fu_360.padded_stream2_blk_n | ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_166_13_fu_381.padded_stream2_blk_n;
...
assign inst_block_sigs[3] = (AESL_inst_accelerator_v2.repack_U0.ap_done & ~AESL_inst_accelerator_v2.repack_U0.ap_continue) | ~AESL_inst_accelerator_v2.repack_U0.grp_repack_Pipeline_VITIS_LOOP_265_2_fu_135.gray_stream3_blk_n;
...
assign inst_idle_sigs[10] = AESL_inst_accelerator_v2.unpack_U0.grp_unpack_Pipeline_VITIS_LOOP_84_2_fu_101.ap_idle;
assign inst_idle_sigs[11] = AESL_inst_accelerator_v2.repack_U0.ap_idle;
assign inst_idle_sigs[12] = AESL_inst_accelerator_v2.repack_U0.grp_repack_Pipeline_VITIS_LOOP_291_3_fu_143.ap_idle;
...
// check block with process 'accelerator_v2.pad_U0'
        if (AESL_inst_accelerator_v2.bgr_stream_U.if_empty_n == 1'b0 && ~AESL_inst_accelerator_v2.unpack_U0.grp_unpack_Pipeline_VITIS_LOOP_84_2_fu_101.bgr_stream1_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
        else if (AESL_inst_accelerator_v2.bgr_stream_U.if_full_n == 1'b0 && ~AESL_inst_accelerator_v2.unpack_U0.grp_unpack_Pipeline_VITIS_LOOP_84_2_fu_101.bgr_stream1_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
...
//  report path when block is found for process 'accelerator_v2.process_pixels_U0'
        if (out_proc_hit[1] == 1'b1) begin
            $display("//");
            $display("//    Process 'accelerator_v2.unpack_U0' is blocked by following channel which connected with process 'accelerator_v2.process_pixels_U0' :");
            $fdisplay(fp,"//");
            $fdisplay(fp,"//    Process 'accelerator_v2.unpack_U0' is blocked by following channel which connected with process 'accelerator_v2.process_pixels_U0' :");
...
reg [4-1:0] out_proc_hit;
begin
    if (1) begin
        out_proc_hit = 4'h0;
// check block with process 'accelerator_v2.unpack_U0'
        if (AESL_inst_accelerator_v2.bgr_stream_U.if_empty_n == 1'b0 && ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_133_1_VITIS_LOOP_134_2_fu_348.bgr_stream1_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
        else if (AESL_inst_accelerator_v2.bgr_stream_U.if_full_n == 1'b0 && ~AESL_inst_accelerator_v2.pad_U0.grp_pad_Pipeline_VITIS_LOOP_133_1_VITIS_LOOP_134_2_fu_348.bgr_stream1_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
...
//  report path when block is found for process 'accelerator_v2.repack_U0'
        if (out_proc_hit[3] == 1'b1) begin
            $display("//");
            $display("//    Process 'accelerator_v2.pad_U0' is blocked by following channel which connected with process 'accelerator_v2.repack_U0' :");
            $fdisplay(fp,"//");
            $fdisplay(fp,"//    Process 'accelerator_v2.pad_U0' is blocked by following channel which connected with process 'accelerator_v2.repack_U0' :");
            report_block_path_in_repack_U0(fp);
        end

        if (out_proc_hit == 4'h0) begin
            $display("//");
...
//  report path when block is found for process 'accelerator_v2.unpack_U0'
        if (out_proc_hit[2] == 1'b1) begin
            $display("//");
            $display("//    Process 'accelerator_v2.process_pixels_U0' is blocked by following channel which connected with process 'accelerator_v2.unpack_U0' :");
            $fdisplay(fp,"//");
            $fdisplay(fp,"//    Process 'accelerator_v2.process_pixels_U0' is blocked by following channel which connected with process 'accelerator_v2.unpack_U0' :");
            report_block_path_in_unpack_U0(fp);
        end
...
begin
    if (axis_block_sigs[2] == 1'b1 || axis_block_sigs[1] == 1'b0) begin
        ...
        out_proc_hit = 4'h0;
// check block with process 'accelerator_v2.process_pixels_U0'
        if (AESL_inst_accelerator_v2.gray_stream_U.if_empty_n == 1'b0 && ~AESL_inst_accelerator_v2.repack_U0.grp_repack_Pipeline_VITIS_LOOP_265_2_fu_135.gray_stream3_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
        else if (AESL_inst_accelerator_v2.gray_stream_U.if_full_n == 1'b0 && ~AESL_inst_accelerator_v2.repack_U0.grp_repack_Pipeline_VITIS_LOOP_265_2_fu_135.gray_stream3_blk_n == 1'b1) begin
            out_proc_hit[0] = 1'b1;
        end
...
//  report path when block is found for process 'accelerator_v2.pad_U0'
        if (out_proc_hit[3] == 1'b1) begin
            $display("//");
            $display("//    Process 'accelerator_v2.repack_U0' is blocked by following channel which connected with process 'accelerator_v2.pad_U0' :");
            $fdisplay(fp,"//");
            $fdisplay(fp,"//    Process 'accelerator_v2.repack_U0' is blocked by following channel which connected with process 'accelerator_v2.pad_U0' :");
            report_block_path_in_pad_U0(fp);
        end
