...
if {[file isfile accelerator_v2.autotvin.dat]} {
	file delete -force accelerator_v2.autotvin.dat
}

if {[file isfile accelerator_v2.autotvout.dat]} {
	file delete -force accelerator_v2.autotvout.dat
}
