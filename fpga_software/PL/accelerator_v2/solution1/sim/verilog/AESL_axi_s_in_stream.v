...
`define TV_IN_in_stream_TDATA "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_data_V.dat"
`define INGRESS_STATUS_in_stream_TDATA "../tv/stream_size/stream_ingress_status_in_stream_V_data_V.dat"
`define TV_IN_in_stream_TKEEP "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_keep_V.dat"
`define INGRESS_STATUS_in_stream_TKEEP "../tv/stream_size/stream_ingress_status_in_stream_V_keep_V.dat"
`define TV_IN_in_stream_TSTRB "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_strb_V.dat"
`define INGRESS_STATUS_in_stream_TSTRB "../tv/stream_size/stream_ingress_status_in_stream_V_strb_V.dat"
`define TV_IN_in_stream_TUSER "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_user_V.dat"
`define INGRESS_STATUS_in_stream_TUSER "../tv/stream_size/stream_ingress_status_in_stream_V_user_V.dat"
`define TV_IN_in_stream_TLAST "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_last_V.dat"
`define INGRESS_STATUS_in_stream_TLAST "../tv/stream_size/stream_ingress_status_in_stream_V_last_V.dat"
`define TV_IN_in_stream_TID "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_id_V.dat"
`define INGRESS_STATUS_in_stream_TID "../tv/stream_size/stream_ingress_status_in_stream_V_id_V.dat"
`define TV_IN_in_stream_TDEST "../tv/cdatafile/c.accelerator_v2.autotvin_in_stream_V_dest_V.dat"
...
module AESL_axi_s_in_stream (
    input clk,
    input reset,
    output [128 - 1:0] TRAN_in_stream_TDATA,
    output [16 - 1:0] TRAN_in_stream_TKEEP,
    output [16 - 1:0] TRAN_in_stream_TSTRB,
    ...
    reg [128 - 1:0] in_stream_TDATA_write_data;
    reg in_stream_TDATA_read_en;
    wire [128 - 1:0] in_stream_TDATA_read_data;
    
    fifo #(58080, 128) fifo_in_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [16 - 1:0] in_stream_TKEEP_write_data;
    reg in_stream_TKEEP_read_en;
    wire [16 - 1:0] in_stream_TKEEP_read_data;
    
    fifo #(58080, 16) fifo_in_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [16 - 1:0] in_stream_TSTRB_write_data;
    reg in_stream_TSTRB_read_en;
    wire [16 - 1:0] in_stream_TSTRB_read_data;
    
    fifo #(58080, 16) fifo_in_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(58080, 1) fifo_in_stream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(58080, 1) fifo_in_stream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(58080, 1) fifo_in_stream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(58080, 1) fifo_in_stream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
