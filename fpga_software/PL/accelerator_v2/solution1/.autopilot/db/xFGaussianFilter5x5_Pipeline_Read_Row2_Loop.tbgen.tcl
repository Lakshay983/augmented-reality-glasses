set moduleName xFGaussianFilter5x5_Pipeline_Read_Row2_Loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xFGaussianFilter5x5_Pipeline_Read_Row2_Loop}
...
set portList { 
	...
	{ buf_V_3_d1 sc_out sc_lv 8 signal 0 } 
}
set NewPortList {[ 
