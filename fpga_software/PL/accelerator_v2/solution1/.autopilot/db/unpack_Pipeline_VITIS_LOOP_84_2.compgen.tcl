...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TVALID { I 1 bit } in_stream_TDATA { I 128 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_breath { O 8 vector } in_breath_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bgr_stream1_din { O 24 vector } bgr_stream1_num_data_valid { I 13 vector } bgr_stream1_fifo_cap { I 13 vector } bgr_stream1_full_n { I 1 bit } bgr_stream1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bgr_fifo_breath \
    op interface \
    ports { bgr_fifo_breath { O 8 vector } bgr_fifo_breath_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 11 \
    name bgr_drain_V_2_out \
    type other \
    dir IO \
    reset_level 1 \
    sync_rst true \
    corename dc_bgr_drain_V_2_out \
    op interface \
    ports { bgr_drain_V_2_out_i { I 8 vector } bgr_drain_V_2_out_o { O 8 vector } bgr_drain_V_2_out_o_ap_vld { O 1 bit } } \
} "
}
