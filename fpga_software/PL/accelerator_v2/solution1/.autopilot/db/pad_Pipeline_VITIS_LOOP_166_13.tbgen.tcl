set moduleName pad_Pipeline_VITIS_LOOP_166_13
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pad_Pipeline_VITIS_LOOP_166_13}
set C_modelType { void 0 }
set C_modelArgList {
	{ drain_count_V_17 int 8 regular  }
	{ row_buf_V int 24 regular {array 640 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "drain_count_V_17", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "row_buf_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "slot", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ padded_stream2_din sc_out sc_lv 24 signal 6 } 
	{ padded_stream2_num_data_valid sc_in sc_lv 13 signal 6 } 
	{ padded_stream2_fifo_cap sc_in sc_lv 13 signal 6 } 
	{ padded_stream2_full_n sc_in sc_logic 1 signal 6 } 
	{ padded_stream2_write sc_out sc_logic 1 signal 6 } 
	{ drain_count_V_17 sc_in sc_lv 8 signal 0 } 
	{ row_buf_V_address0 sc_out sc_lv 10 signal 1 } 
	{ row_buf_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ row_buf_V_q0 sc_in sc_lv 24 signal 1 } 
	{ row_buf_V_1_address0 sc_out sc_lv 10 signal 2 } 
	{ row_buf_V_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ row_buf_V_1_q0 sc_in sc_lv 24 signal 2 } 
	{ row_buf_V_2_address0 sc_out sc_lv 10 signal 3 } 
	{ row_buf_V_2_ce0 sc_out sc_logic 1 signal 3 } 
	{ row_buf_V_2_q0 sc_in sc_lv 24 signal 3 } 
	{ row_buf_V_3_address0 sc_out sc_lv 10 signal 4 } 
	{ row_buf_V_3_ce0 sc_out sc_logic 1 signal 4 } 
	{ row_buf_V_3_q0 sc_in sc_lv 24 signal 4 } 
	{ slot sc_in sc_lv 2 signal 5 } 
	{ pad_fifo_breath sc_out sc_lv 8 signal 7 } 
	{ pad_fifo_breath_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "drain_count_V_17", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "drain_count_V_17", "role": "default" }} , 
 	...
 	{ "name": "row_buf_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "row_buf_V", "role": "q0" }} , 
 	...
 	{ "name": "slot", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "slot", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_24_1_1_U45", "Parent" : "0"},
...
set Spec2ImplPortList { 
	drain_count_V_17 { ap_none {  { drain_count_V_17 in_data 0 8 } } }
	row_buf_V { ap_memory {  { row_buf_V_address0 mem_address 1 10 }  { row_buf_V_ce0 mem_ce 1 1 }  { row_buf_V_q0 in_data 0 24 } } }
