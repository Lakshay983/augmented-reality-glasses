set moduleName repack_Pipeline_VITIS_LOOP_280_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {repack_Pipeline_VITIS_LOOP_280_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ row_pixels_V int 8 regular {array 644 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ cmp39 int 1 regular  }
	{ cmp43 int 1 regular  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_pixels_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "row_pixels_V", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	row_pixels_V { ap_memory {  { row_pixels_V_address0 mem_address 1 10 }  { row_pixels_V_ce0 mem_ce 1 1 }  { row_pixels_V_q0 in_data 0 8 }  { row_pixels_V_address1 MemPortADDR2 1 10 }  { row_pixels_V_ce1 MemPortCE2 1 1 }  { row_pixels_V_q1 MemPortDOUT2 0 8 } } }
