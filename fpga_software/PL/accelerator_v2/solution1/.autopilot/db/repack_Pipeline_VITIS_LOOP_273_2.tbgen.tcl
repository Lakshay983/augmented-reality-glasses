set moduleName repack_Pipeline_VITIS_LOOP_273_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {repack_Pipeline_VITIS_LOOP_273_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gray_stream3 int 8 regular {fifo 0 volatile }  }
	{ row_pixels_V int 8 regular {array 644 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
...
set portList { 
	...
	{ row_pixels_V_address0 sc_out sc_lv 10 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_pixels_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "row_pixels_V", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	row_pixels_V { ap_memory {  { row_pixels_V_address0 mem_address 1 10 }  { row_pixels_V_ce0 mem_ce 1 1 }  { row_pixels_V_we0 mem_we 1 1 }  { row_pixels_V_d0 mem_din 1 8 } } }
}
