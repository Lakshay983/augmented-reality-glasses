...
entity accelerator_v2_fifo_w24_d311696_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 24;
        ADDR_WIDTH        : integer := 19;
        DEPTH             : integer := 311695);
    port (
        clk               : in  std_logic;
        reset             : in  std_logic;
...
architecture arch of accelerator_v2_fifo_w24_d311696_A is

    -- component
    component accelerator_v2_fifo_w24_d311696_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 24;
        ADDR_WIDTH : natural := 19;
        DEPTH      : natural := 311695);
    port (
        clk        : in std_logic;
        reset      : in std_logic;
        we         : in std_logic;
...
begin
----------------------- Instantiation -----------------------
    U_accelerator_v2_fifo_w24_d311696_A_ram : accelerator_v2_fifo_w24_d311696_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity accelerator_v2_fifo_w24_d311696_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 24;
        ADDR_WIDTH  : integer := 19;
...
architecture arch of accelerator_v2_fifo_w24_d311696_A_ram is
