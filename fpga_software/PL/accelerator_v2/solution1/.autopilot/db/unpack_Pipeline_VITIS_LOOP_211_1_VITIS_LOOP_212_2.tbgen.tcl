set moduleName unpack_Pipeline_VITIS_LOOP_211_1_VITIS_LOOP_212_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {unpack_Pipeline_VITIS_LOOP_211_1_VITIS_LOOP_212_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ frame_start_out_in_load int 1 regular  }
	{ frame_started_load int 1 regular  }
	...
	{ p_02_out int 1 regular {pointer 1}  }
	{ frame_started_flag_1_out int 1 regular {pointer 1}  }
	{ frame_started_new_1_out int 1 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "frame_start_out_in_load", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "frame_started_load", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_02_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "frame_started_flag_1_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "frame_started_new_1_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ bgr_stream1_din sc_out sc_lv 24 signal 10 } 
	{ bgr_stream1_num_data_valid sc_in sc_lv 20 signal 10 } 
	{ bgr_stream1_fifo_cap sc_in sc_lv 20 signal 10 } 
	{ bgr_stream1_full_n sc_in sc_logic 1 signal 10 } 
	{ bgr_stream1_write sc_out sc_logic 1 signal 10 } 
	{ frame_start_out_in_load sc_in sc_lv 1 signal 0 } 
	{ frame_started_load sc_in sc_lv 1 signal 1 } 
	{ in_stream_TDATA sc_in sc_lv 128 signal 2 } 
	{ in_stream_TVALID sc_in sc_logic 1 invld 2 } 
	{ in_stream_TREADY sc_out sc_logic 1 inacc 8 } 
	{ in_stream_TKEEP sc_in sc_lv 16 signal 3 } 
	{ in_stream_TSTRB sc_in sc_lv 16 signal 4 } 
	...
	{ hdr_stream4_din sc_out sc_lv 8 signal 9 } 
	{ hdr_stream4_num_data_valid sc_in sc_lv 17 signal 9 } 
	{ hdr_stream4_fifo_cap sc_in sc_lv 17 signal 9 } 
	{ hdr_stream4_full_n sc_in sc_logic 1 signal 9 } 
	{ hdr_stream4_write sc_out sc_logic 1 signal 9 } 
	{ p_02_out sc_out sc_lv 1 signal 11 } 
	{ p_02_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ frame_started_flag_1_out sc_out sc_lv 1 signal 12 } 
	{ frame_started_flag_1_out_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ frame_started_new_1_out sc_out sc_lv 1 signal 13 } 
	{ frame_started_new_1_out_ap_vld sc_out sc_logic 1 outvld 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "frame_start_out_in_load", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "frame_start_out_in_load", "role": "default" }} , 
 	{ "name": "frame_started_load", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "frame_started_load", "role": "default" }} , 
 	...
 	{ "name": "p_02_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "p_02_out", "role": "default" }} , 
 	{ "name": "p_02_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "p_02_out", "role": "ap_vld" }} , 
 	{ "name": "frame_started_flag_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "frame_started_flag_1_out", "role": "default" }} , 
 	{ "name": "frame_started_flag_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "frame_started_flag_1_out", "role": "ap_vld" }} , 
 	{ "name": "frame_started_new_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "frame_started_new_1_out", "role": "default" }} , 
 	{ "name": "frame_started_new_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "frame_started_new_1_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	frame_start_out_in_load { ap_none {  { frame_start_out_in_load in_data 0 1 } } }
	frame_started_load { ap_none {  { frame_started_load in_data 0 1 } } }
	in_stream_V_data_V { axis {  { in_stream_TDATA in_data 0 128 }  { in_stream_TVALID in_vld 0 1 } } }
	...
	p_02_out { ap_vld {  { p_02_out out_data 1 1 }  { p_02_out_ap_vld out_vld 1 1 } } }
	frame_started_flag_1_out { ap_vld {  { frame_started_flag_1_out out_data 1 1 }  { frame_started_flag_1_out_ap_vld out_vld 1 1 } } }
	frame_started_new_1_out { ap_vld {  { frame_started_new_1_out out_data 1 1 }  { frame_started_new_1_out_ap_vld out_vld 1 1 } } }
}
