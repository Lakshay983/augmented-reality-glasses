set moduleName pad_Pipeline_VITIS_LOOP_93_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pad_Pipeline_VITIS_LOOP_93_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ row_buf_V_3 int 24 regular {array 640 { 0 3 } 0 1 }  }
	{ row_buf_V_2 int 24 regular {array 640 { 0 3 } 0 1 }  }
	{ bgr_stream1 int 24 regular {fifo 0 volatile }  }
	{ trunc_ln87_1 int 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "row_buf_V_3", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "trunc_ln87_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ bgr_stream1_num_data_valid sc_in sc_lv 20 signal 2 } 
	{ bgr_stream1_fifo_cap sc_in sc_lv 20 signal 2 } 
	{ bgr_stream1_empty_n sc_in sc_logic 1 signal 2 } 
	{ bgr_stream1_read sc_out sc_logic 1 signal 2 } 
	{ row_buf_V_3_address0 sc_out sc_lv 10 signal 0 } 
	{ row_buf_V_3_ce0 sc_out sc_logic 1 signal 0 } 
	{ row_buf_V_3_we0 sc_out sc_logic 1 signal 0 } 
	{ row_buf_V_3_d0 sc_out sc_lv 24 signal 0 } 
	{ row_buf_V_2_address0 sc_out sc_lv 10 signal 1 } 
	{ row_buf_V_2_ce0 sc_out sc_logic 1 signal 1 } 
	{ row_buf_V_2_we0 sc_out sc_logic 1 signal 1 } 
	{ row_buf_V_2_d0 sc_out sc_lv 24 signal 1 } 
	{ trunc_ln87_1 sc_in sc_lv 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buf_V_3_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "row_buf_V_3", "role": "we0" }} , 
 	{ "name": "row_buf_V_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "row_buf_V_3", "role": "d0" }} , 
 	...
 	{ "name": "trunc_ln87_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "trunc_ln87_1", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	row_buf_V_3 { ap_memory {  { row_buf_V_3_address0 mem_address 1 10 }  { row_buf_V_3_ce0 mem_ce 1 1 }  { row_buf_V_3_we0 mem_we 1 1 }  { row_buf_V_3_d0 mem_din 1 24 } } }
	...
	trunc_ln87_1 { ap_none {  { trunc_ln87_1 in_data 0 1 } } }
}
