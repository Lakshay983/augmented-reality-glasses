...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bgr_stream1_din { O 24 vector } bgr_stream1_num_data_valid { I 14 vector } bgr_stream1_fifo_cap { I 14 vector } bgr_stream1_full_n { I 1 bit } bgr_stream1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_breath { O 1 vector } in_breath_ap_vld { O 1 bit } } \
} "
}
