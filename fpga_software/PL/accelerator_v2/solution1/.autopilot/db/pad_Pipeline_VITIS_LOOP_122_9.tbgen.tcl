set moduleName pad_Pipeline_VITIS_LOOP_122_9
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "row_buf_V_2", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "r_5_cast", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ padded_stream2_num_data_valid sc_in sc_lv 13 signal 3 } 
	{ padded_stream2_fifo_cap sc_in sc_lv 13 signal 3 } 
	...
	{ row_buf_V_2_q0 sc_in sc_lv 24 signal 0 } 
	{ row_buf_V_3_address0 sc_out sc_lv 10 signal 1 } 
	{ row_buf_V_3_ce0 sc_out sc_logic 1 signal 1 } 
	{ row_buf_V_3_q0 sc_in sc_lv 24 signal 1 } 
	{ r_5_cast sc_in sc_lv 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r_5_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "r_5_cast", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_24_1_1_U47", "Parent" : "0"},
