...
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start;
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_done;
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_idle;
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_ready;
wire   [23:0] grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_bgr_stream1_din;
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_bgr_stream1_write;
wire    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_in_stream_TREADY;
reg    grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
reg   [6:0] tx_fu_62;
wire   [6:0] tx_2_fu_126_p2;
reg    ap_block_state2;
reg    ap_block_state1;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
#0 grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg = 1'b0;
#0 in_breath_preg = 1'd0;
end

accelerator_v2_unpack_Pipeline_VITIS_LOOP_53_2 grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0)) & (icmp_ln39_fu_120_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state3)) begin
            grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg <= 1'b1;
        end else if ((grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_ready == 1'b1)) begin
            grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0)) & (icmp_ln39_fu_120_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln41_fu_132_p2 == 1'd1))) begin
            in_breath_preg <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        tx_fu_62 <= 7'd0;
    end else if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0)) & (icmp_ln39_fu_120_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0))) begin
...
always @ (*) begin
    if ((grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0)) & (icmp_ln39_fu_120_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0)) & (icmp_ln39_fu_120_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end
...
always @ (*) begin
    ap_block_state2 = ((icmp_ln39_fu_120_p2 == 1'd0) & (in_stream_TVALID_int_regslice == 1'b0));
end

assign ap_ready = internal_ap_ready;

assign bgr_stream1_din = grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_bgr_stream1_din;

assign grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start = grp_unpack_Pipeline_VITIS_LOOP_53_2_fu_92_ap_start_reg;

assign icmp_ln39_fu_120_p2 = ((tx_fu_62 == 7'd96) ? 1'b1 : 1'b0);

assign icmp_ln41_fu_132_p2 = ((tx_fu_62 == 7'd0) ? 1'b1 : 1'b0);

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign start_out = real_start;

assign tx_2_fu_126_p2 = (tx_fu_62 + 7'd1);
