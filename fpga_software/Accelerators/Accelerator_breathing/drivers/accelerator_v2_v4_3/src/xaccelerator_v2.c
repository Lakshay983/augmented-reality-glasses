...
u32 XAccelerator_v2_Get_in_breath(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_IN_BREATH_DATA);
    return Data;
}
...
u32 XAccelerator_v2_Get_in_breath_vld(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_IN_BREATH_CTRL);
    return Data & 0x1;
}
...
u32 XAccelerator_v2_Get_out_breath(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_OUT_BREATH_DATA);
    return Data;
}
...
u32 XAccelerator_v2_Get_out_breath_vld(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_OUT_BREATH_CTRL);
    return Data & 0x1;
}
...
u32 XAccelerator_v2_Get_bgr_fifo_breath(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_BGR_FIFO_BREATH_DATA);
    return Data;
}
...
u32 XAccelerator_v2_Get_bgr_fifo_breath_vld(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_BGR_FIFO_BREATH_CTRL);
    return Data & 0x1;
}
...
u32 XAccelerator_v2_Get_pad_fifo_breath(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_PAD_FIFO_BREATH_DATA);
    return Data;
}
...
u32 XAccelerator_v2_Get_pad_fifo_breath_vld(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_PAD_FIFO_BREATH_CTRL);
    return Data & 0x1;
}
...
u32 XAccelerator_v2_Get_gray_fifo_breath(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_GRAY_FIFO_BREATH_DATA);
    return Data;
}
...
u32 XAccelerator_v2_Get_gray_fifo_breath_vld(XAccelerator_v2 *InstancePtr) {
    ...
    Data = XAccelerator_v2_ReadReg(InstancePtr->Ctrl_BaseAddress, XACCELERATOR_V2_CTRL_ADDR_GRAY_FIFO_BREATH_CTRL);
    return Data & 0x1;
}
