...
module accelerator_v2_hls_deadlock_idx0_monitor ( // for module accelerator_v2_accelerator_v2_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 accelerator_v2_hls_deadlock_idx1_monitor accelerator_v2_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 accelerator_v2_hls_deadlock_idx3_monitor accelerator_v2_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
