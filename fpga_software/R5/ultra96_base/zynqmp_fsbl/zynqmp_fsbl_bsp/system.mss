...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI4_BURST_MASTER
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI4_BURST_MASTER_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.8
 PARAMETER HW_INSTANCE = BRAM_axi_bram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_BD_CTL_GPIO_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_BD_CTL_GPIO_axi_gpio_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_Low_Speed_MEZZ_PWM_w_Int_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_Low_Speed_MEZZ_PWM_w_Int_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_Low_Speed_MEZZ_axi_gpio_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartns550
 PARAMETER DRIVER_VER = 3.8
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_Low_Speed_MEZZ_axi_uart16550_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartns550
 PARAMETER DRIVER_VER = 3.8
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_Low_Speed_MEZZ_axi_uart16550_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_SYS_MGMT_axi_gpio_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sysmon
 PARAMETER DRIVER_VER = 7.7
 PARAMETER HW_INSTANCE = ULTRA96_SYSTEM_SYS_MGMT_system_management_wiz_0
END
